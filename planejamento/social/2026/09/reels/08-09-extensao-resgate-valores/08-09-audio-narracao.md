...
1. **"Prêmio de loteria tem prazo de resgate. Depois disso, o dinheiro simplesmente some."**
2. **"E não é só o prêmio grande que a gente esquece de resgatar. Os pequenos também têm prazo."**
3. **"Eu acompanho seus jogos, identifico os premiados e automatizo o resgate."**
4. **"E já funciona para todas as loterias da Caixa."**
5. **"Extensão gratuita. Link na bio."**

Ler como um áudio único e contínuo (não 5 arquivos separados): as pausas naturais entre as falas marcam o corte entre as cenas do vídeo depois. Gerar tudo de uma vez para a entonação fluir como uma linha de raciocínio, não como frases soltas coladas.
...
|---|---|---|
| 1. "Prêmio de loteria tem prazo..." | Cena 1 (abertura) | ~4–5s |
| 2. "E não é só o prêmio grande..." | Cena 2 (achando bilhete antigo) | ~4–5s |
| 3. "Eu acompanho seus jogos..." | Cena 3 (extensão identificando premiados) | ~4–5s |
...
Trilha instrumental (tecnológica, moderna, minimalista, discreta) e efeitos sonoros de interface por cima da narração, em volume bem mais baixo. A voz do Trevin precisa ficar perfeitamente inteligível o tempo todo, pois carrega toda a informação que antes estaria em texto na tela.

---

## O QUE ISSO MUDA NO ROTEIRO DE VÍDEO

O roteiro em `08-09-extensao-resgate-valores.md` já foi escrito considerando esse formato narrado (sem "Texto:" mudo na tela). Ao gerar os prompts de vídeo de cada cena, usar as durações reais medidas neste áudio, não as estimativas acima.

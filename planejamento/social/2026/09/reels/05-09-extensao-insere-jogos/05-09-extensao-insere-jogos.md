...
Tela real de navegador, sem edição que pareça exagero — a credibilidade vem de mostrar o processo real. Contraste de velocidade (manual x automático) é o efeito principal.

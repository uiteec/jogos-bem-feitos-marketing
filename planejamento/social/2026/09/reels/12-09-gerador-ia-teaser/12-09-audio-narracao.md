...
O roteiro em `12-09-gerador-ia-teaser.md` já foi escrito considerando esse formato narrado (sem "Texto:" mudo na tela). Ao gerar os prompts de vídeo de cada cena, usar as durações reais medidas neste áudio, não as estimativas acima.
